            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center gap-3 flex-shrink-0">
                    ...
                    <a href="/admin/login.php"
                        class="hidden md:inline-flex items-center px-4 py-2 border-2 border-primary-600 text-primary-700 font-semibold rounded-lg hover:bg-primary-50 transition text-sm">
                    ...
                    <?php if ($is_logged_in): ?>
                        <div class="relative group">
                            <button
                                ...
                                <?php else: ?>
                                    <!-- Fallback Ikon User jika belum ada foto -->
