...
<head>
    ...
    <title>Daftar Akun - Sodakoh Pohon</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="login.php" class="inline-flex items-center px-5 py-2.5 bg-white border-2 border-primary-600 text-primary-700 font-semibold rounded-xl hover:bg-primary-50 transition">
