            ...
            <div class="bg-white rounded-2xl shadow-card p-6 space-y-6">
                ...
                <div>
                    <h2 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                        <span
                            class="w-6 h-6 bg-primary-600 text-white rounded-lg flex items-center justify-center text-sm mr-3">1</span>
                        Identitas Donatur
                    </h2>
                ...
                <div class="pt-6 border-t border-gray-200">
                    <h2 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                        <span
                            class="w-6 h-6 bg-primary-600 text-white rounded-lg flex items-center justify-center text-sm mr-3">2</span>
                        Doa & Ucapan (Opsional)
                    </h2>

                    <div>
                        <textarea rows="3" placeholder="Tulis doa atau ucapan untuk program ini..."
                ...
                <div class="pt-6 border-t border-gray-200">
                    <h2 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                        <span
                            class="w-6 h-6 bg-primary-600 text-white rounded-lg flex items-center justify-center text-sm mr-3">3</span>
                        Metode Pembayaran
                    </h2>

                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div
                            class="payment-method-card active border-2 border-primary-600 bg-primary-50 rounded-xl p-4 text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Bank_Central_Asia.svg"
                                alt="BCA" class="h-6 mx-auto mb-2">
                            <span class="text-xs font-semibold text-primary-700">BCA Virtual Account</span>
                        </div>
                        <div
                            class="payment-method-card border-2 border-gray-200 rounded-xl p-4 text-center hover:border-primary-600">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/9/94/Bank_Mandiri_logo.svg"
                                alt="Mandiri" class="h-6 mx-auto mb-2">
                        ...
                        <div
                            class="payment-method-card border-2 border-gray-200 rounded-xl p-4 text-center hover:border-primary-600">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/8/83/BNI_logo.svg" alt="BNI"
                                class="h-6 mx-auto mb-2">
                ...
                <div class="pt-6 border-t border-gray-200">
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-3 text-sm text-gray-600">
                            Saya setuju dengan <a href="#" class="text-primary-700 font-semibold hover:underline">syarat
                                dan ketentuan</a> yang berlaku serta menyatakan bahwa donasi ini sah dan tidak melanggar
                            hukum.
                        </label>
                    </div>
                </div>
                ...
                <div class="flex justify-between text-sm mb-3">
                    <div>
                        ...
                        <span class="text-gray-500 block text-xs">
                            <?php echo $item['quantity']; ?> pohon x Rp
                            <?php echo number_format($item['price_per_tree']); ?>
                        </span>
                    </div>
